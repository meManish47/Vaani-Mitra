          ...
          >
            <div className="flex flex-col gap-4 p-4 md:p-8">
              <div>
                ...
                >
                  Enter the new profile picture
                </label>
                <input
                  type="file"
                  required={true}
                  onChange={handleChange}
                  className="w-full rounded border bg-red-50 px-3 py-2 text-red-500 outline-none ring-indigo-300 transition duration-100 focus:ring"
                />
              </div>
              ...
              {/* <Link href={"/settings"}> */}
              <button className="block rounded-lg bg-red-500 px-8 py-3 text-center text-sm font-bold text-white outline-none ring-red-300 transition duration-100 hover:bg-red-700 focus-visible:ring active:bg-red-600 md:text-base">
                Update
              </button>
              {/* </Link> */}
            </div>
